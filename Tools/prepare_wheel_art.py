"""Flatten the original wheel meshes and independently sample both source rigs."""
import copy
import json
import struct
...
rigs = []
for name in ('ef_slzhuanpandi', 'ef_slzhuanpanzz'):
...
(root / 'Tools/Evidence/wheel-art-poses.json').write_text(json.dumps({'rigs': rigs}), encoding='utf8')
