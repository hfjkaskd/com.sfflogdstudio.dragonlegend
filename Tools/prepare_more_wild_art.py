"""Flatten original Extra Wild meshes for the existing native Unity UI rig author."""
import json
from pathlib import Path

root = Path(__file__).resolve().parents[1]
data = json.loads((root / 'Tools/Evidence/Wild/ef_wild3.json').read_text(encoding='utf8'))
meshes = []
...
(output / 'ef_wild3.json').write_text(json.dumps({'meshes': meshes}), encoding='utf8')
