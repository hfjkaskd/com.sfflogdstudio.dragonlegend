...
public static class BuildWildWorld
{
    ...
    public static GameObject Create(Transform parent, string name, string file, string directory,string folder=Folder,bool loop=true, string sourceFolder="Artifacts/WildAuthoring", string clipName=null,string atlasPath=null,bool configureTexture=true)
    {
        ...
        if(configureTexture) { importer.alphaIsTransparency = false; importer.textureCompression = TextureImporterCompression.Uncompressed; importer.SaveAndReimport(); }
