...
public static class BuildGmPanel
{
    public static void Save()
    {
        ...
        try {
            ...
            var rect=(RectTransform)toggle.transform;rect.anchorMin=rect.anchorMax=rect.pivot=Vector2.zero;rect.anchoredPosition=new Vector2(16,16);rect.sizeDelta=new Vector2(96,64);
