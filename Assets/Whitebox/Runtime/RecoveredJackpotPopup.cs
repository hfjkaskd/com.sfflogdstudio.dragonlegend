...
{
    public sealed class RecoveredJackpotPopup : MonoBehaviour, IRecoveredJackpotClaimView
    {
        ...
        private RecoveredJackpotClaim claim;
        ...
        public RecoveredJackpotClaim Claim => claim;
        ...
        public void Show(RecoveredJackpotType type, float amount, RecoveredPlayerProgress progress,
            RecoveredGameplayRules rules, IAdFacade ads, bool isA, int languageType, Action<float> completed)
        {
            int animation;
            switch (type)
            {
                case RecoveredJackpotType.Grand: animation = 0; break;
                case RecoveredJackpotType.Major: animation = 1; break;
                case RecoveredJackpotType.Minor: animation = 2; break;
            ...
            claim = new RecoveredJackpotClaim(progress, rules, ads, this);
            claim.BeforeShow(amount, completed);
            PauseMusicRequested?.Invoke(); Sound1Requested?.Invoke("jackpotBg"); PlaySound("jackpotm");
            ...
            CashOutTaskRefreshRequested?.Invoke(2, 1);
