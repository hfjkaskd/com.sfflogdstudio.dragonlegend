...
namespace DragonLegend.Whitebox
{
    ...
    public sealed class RecoveredRegionRig : MaskableGraphic
    {
        ...
        [Serializable] public sealed class Slot {public int bone;public float attachment;public Color tint=Color.white;public bool additive;}
        [Serializable] public sealed class Region {public Vector2[] vertices,uv;public Color tint=Color.white;}
        public Bone[] bones;
        public Slot[] slots;
        ...
        public void RefreshPose()
        {
            ...
            for(int i=0;i<bones.Length;i++) {
                var bone=bones[i];if(bone.mode!=0&&bone.mode!=3)throw new InvalidOperationException("Unsupported bone inheritance");var parent=bone.parent<0?Matrix4x4.identity:matrices[bone.parent];
        ...
        protected override void OnPopulateMesh(VertexHelper mesh)
        {
            ...
            for(int i=0;i<slots.Length;i++) {
                ...
                var region=regions[index];Color tint=slot.tint*region.tint*color;
